...
namespace MalbersAnimations.Controller.AI
{
    ...
    public class MAIState : ScriptableObject
    {
        ...
        ///// <summary> Notify the Tasks that the Animal has arrived to the Destination Position </summary>
            ...
            Reo_List_Tasks = new ReorderableList(serializedObject, tasks, true, true, true, true)
            {
                drawElementCallback = (rect, index, isActive, isFocused) =>
                {
                    ...
                    if (isWaiting)
                    {
                        ...
                        {
                            width = 20,  height = r.height+2, y = r.y-2, 
                            x = rect.width + 25
                        };
                ...
                onRemoveCallback = list =>
                {
                    ...
                    if (tasks.arraySize > list.index)
                    {
                        task = tasks.GetArrayElementAtIndex(list.index); //Recheck the Task again
