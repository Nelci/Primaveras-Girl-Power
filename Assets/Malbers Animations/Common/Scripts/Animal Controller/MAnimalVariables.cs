    ...
    public partial class MAnimal
    {
       // public List<bool> StateLocalActive;
        ...
        public State ActiveState
        {
            ...
            internal set
            {
                ...
                this.Delay_Action(() => { JustActivateState = false; });            //Reset this value the next Frame
       ...
       internal Vector3 additivePosition;
        ...
        public bool Sprint
        {
            ...
            set
            {
                var newRealSprint = UseSprintState && value && UseSprint && MovementDetected && !SpeedChangeLocked; //Check if the animal has movement
       ...
       // public MStatus ModeInternalStatus { get; internal set; }
        ...
        public bool Strafe
        {
            ...
            set
            {
                ...
                if (!m_strafe.Value)    ResetCameraInput();
            }
        }
        ...
        private MSpeedSet defaultSpeedSet = new MSpeedSet()
        ...
        public MSpeedSet CurrentSpeedSet
        {
            ...
            internal set
            {
                ...
                //Debug.Log("currentSpeedSet = " + currentSpeedSet.name); 
            }
        }
