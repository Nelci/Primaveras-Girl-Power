...
namespace MalbersAnimations.Controller
{
    ...
    public class Climb : State
    {
        ...
        [Tooltip("Radius to of the Ray to find a Climable Wall")]
      ...
      //private bool WallClimbTag;
        ...
        {  
            ...
            {
                if (Physics.Raycast(MainPivot, Gravity, out _, ScaleFactor * GroundDistance, ClimbLayer.Value, IgnoreTrigger)) //Means that the Animal is going down and touching the ground
                {
                   // Debugging($" -[Try Exit] when Grounded and pressing Backwards");
