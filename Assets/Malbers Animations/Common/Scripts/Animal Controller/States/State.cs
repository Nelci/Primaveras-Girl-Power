...
namespace MalbersAnimations.Controller
{
    public abstract class State : ScriptableObject
    {
        ...
        public virtual void AwakeState()
        {
            ...
            if (SpeedSet.Count > 0) SpeedSet.Sort(); //IMPORTANT!
        ...
        {
            foreach (var set in this.SpeedSet)
            {
                    ...
                    animal.Stance != 0 && set.HasStance(animal.Stance))
                {
                    ...
                    animal.CurrentSpeedIndex = set.CurrentIndex;
                    return;
                }
            }
            animal.ResetSpeedSet();
        }
    ...
    public class StateEd : Editor
    {
        SerializedProperty
           ID, Input, ExitInput,  Priority, General, GeneralMessage, TryLoop, EnterTag, ExitTag, ExitFrame, ExitOnMain, ExitCooldown, EnterCooldown,
            CanStrafe, MovementStrafe, IdleStrafe, debug, UseSendMessage, IncludeChildren,
