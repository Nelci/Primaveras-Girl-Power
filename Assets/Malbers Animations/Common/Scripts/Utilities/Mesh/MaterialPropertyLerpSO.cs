...
namespace MalbersAnimations.Utilities
{
    ...
    public class MaterialPropertyLerpSO : ScriptableCoroutine
    {
        ...
        public virtual void LerpSharedMaterial(Renderer mesh)
        {
            ...
            switch (propertyType)
            {
                case MaterialPropertyType.Float:
                    ICoroutine = LerperFloat(mesh,true, time, curve);
                    break;
                case MaterialPropertyType.Color:
                   ICoroutine = LerperColor(mesh,true, ColorValue, time, curve);
                    break;
                case MaterialPropertyType.HDRColor:
                    ICoroutine = LerperColor(mesh,true, ColorHDRValue, time, curve);
                    break;
                default:
                    break;
        ...
        internal override void Evaluate(MonoBehaviour mono, Transform target, float time, AnimationCurve curve = null)
        {
            ...
            {
                case MaterialPropertyType.Float:
                    mono.StartCoroutine(LerperFloat(t, false,time, curv));
                    break;
                case MaterialPropertyType.Color:
                    mono.StartCoroutine(LerperColor(t, false, ColorValue, time, curv));
                    break;
                case MaterialPropertyType.HDRColor:
                    mono.StartCoroutine(LerperColor(t, false, ColorHDRValue, time, curv));
                    break;
                default:
                    break;
        ...
        public virtual void LerpMaterial(Renderer mesh)
        {
            if (mesh)
            {
                ...
                {
                    case MaterialPropertyType.Float:
                        ICoroutine = LerperFloat(mesh, false, time, curve);
                        break;
                    case MaterialPropertyType.Color:
                        ICoroutine = LerperColor(mesh, false, ColorValue, time, curve);
                        break;
                    case MaterialPropertyType.HDRColor:
                        ICoroutine = LerperColor(mesh, false, ColorHDRValue, time, curve);
                        break;
                    default:
                        break;
        ...
        IEnumerator LerperFloat(Renderer mesh, bool shared, float time, AnimationCurve curve)
        {
            float elapsedTime = 0;
        ...
        IEnumerator LerperColor(Renderer mesh, bool shared, Color FinalColor,  float time, AnimationCurve curve)
        {
            float elapsedTime = 0;
