...
namespace MalbersAnimations.Controller
{
    ...
    {
        public readonly string version = "Animal Controller [v1.3c]";
      ...
      //  private ReorderableList Reo_List_Pivots;
        ...
        SerializedProperty
            ...
            AlignRotLerp, m_gravity, m_gravityPower, useCameraUp, ground_Changes_Gravity,
             useSprintGlobal,  SmoothVertical, TurnMultiplier, TurnLimit, Player, OverrideStartState, CloneStates, S_Speed_List, UseCameraInput,
       ...
       // private MonoScript script;
        ...
        private void Draw_Element_State(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            if (Application.isPlaying)
            {
                ...
                else if (state.OnActiveQueue) st_label = "[Queued]";
            }
