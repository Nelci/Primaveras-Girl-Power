...
namespace MalbersAnimations.Scriptables
{
    ...
    public class RuntimeGameObjects : RuntimeCollection<GameObject>
    {
        ...
        public override void OnAddEvent(GameObject newItem) => OnItemAdded.Invoke(newItem);
        public override void OnRemoveEvent(GameObject newItem) => OnItemRemoved.Invoke(newItem);
    }
