        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginVertical(MTools.StyleGray);
            {
                ...
                UseSendMessage.boolValue = GUILayout.Toggle(UseSendMessage.boolValue,
                    new GUIContent("SendMessage()", "Uses the SendMessage() method, instead of checking for IAnimator Listener Interfaces"), EditorStyles.miniButton); nextFrame.boolValue = GUILayout.Toggle(nextFrame.boolValue,
