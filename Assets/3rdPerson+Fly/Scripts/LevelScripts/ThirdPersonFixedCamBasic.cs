...
public class ThirdPersonFixedCamBasic : MonoBehaviour 
{
	...
	public float initialAngleH = 0;                                          // Float to store camera horizontal angle related to mouse movement.
	public float initialAngleV = -20f; 
